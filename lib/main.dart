  ...
  runApp(MaterialApp(
    ...
    theme: ThemeData(
      ...
      textTheme: const TextTheme(
        headline2: TextStyle(fontSize:40.0, fontWeight: FontWeight.bold,color: Colors.white,letterSpacing: 1.5,),),
            ...
            children: [
              Expanded(
                child: Container(
                  ...
                  child: Text('NearCals', style: Theme.of(context).textTheme.headline2,),
                ),
              ),
              Expanded(
                flex: 2,
